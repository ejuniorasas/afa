...
#Mongoid::Includes improves eager loading in Mongoid,
# supporting polymorphic associations, and up to two-levels of eager loading.
gem 'mongoid_includes', '~> 2.1'