...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { last_name: @family.last_name, status: @family.status } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { last_name: @family.last_name, status: @family.status } }
